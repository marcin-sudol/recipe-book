...
var EditPopup = /*#__PURE__*/function (_Popup) {
  ...
  _createClass(EditPopup, [{
    ...
    value: function addStep() {
      ...
      item.innerHTML = "<input type=\"text\" class=\"input-step\" id=\"input-step-".concat(nextId, "\" placeholder=\"Enter step\">\n    <label class=\"input-time-label\" for=\"input-time-").concat(nextId, "\">minutes:</label>\n    <input class=\"input-time\" id=\"input-time-").concat(nextId, "\" type=\"number\" placeholder=\"min\" min=\"5\" max=\"180\" step=\"5\">");
