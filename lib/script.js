...
var Nav = /*#__PURE__*/function () {
  ...
  _createClass(Nav, [{
    ...
    value: function add(obj) {
      ...
      button.type = "button";
      button.innerText = obj.name; // not working
...
var RecipeApp = /*#__PURE__*/function () {
  function RecipeApp(arr) {
    ...
    this.recipeWindow = new RecipeWindow(this.popups.editor.openToEdit, this.popups["delete"].open);
    this.nav = new Nav(this.arr, this.recipeWindow.open, this.popups.editor.openToAdd);
  }
  ...
  _createClass(RecipeApp, [{
    ...
    value: function saveRecipe(obj) {
      if (!obj.hasOwnProperty("id")) {
        ...
        this.arr[index] = obj;
        this.nav.update(obj);
        this.recipeWindow.update(obj); // not working because recipe item connected to specified object
      }
    }
  }]);
...
var EditorWindow = /*#__PURE__*/function (_PopupWindow) {
  _inherits(EditorWindow, _PopupWindow);

  var _super = _createSuper(EditorWindow);

  function EditorWindow(openCallback, closeCallback, saveCallback) {
    var _this8;
...
var DeleteWindow = /*#__PURE__*/function (_PopupWindow2) {
  _inherits(DeleteWindow, _PopupWindow2);

  var _super2 = _createSuper(DeleteWindow);

  function DeleteWindow(openCallback, closeCallback, deleteCallback) {
    var _this10;

    _classCallCheck(this, DeleteWindow);
  ...
  _createClass(DeleteWindow, [{
    key: "open",
    value: function open(obj) {
      this.obj = obj;

      _get(_getPrototypeOf(DeleteWindow.prototype), "open", this).call(this);
    }
  }, {
    key: "submit",
    value: function submit() {
