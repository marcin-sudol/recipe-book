...
var getAnimationTime = function getAnimationTime() {
  return parseFloat(window.getComputedStyle(document.getElementById("recipe")).transitionDuration.split(",")[0]) * 1000;
}; // -------------------------------------------------------
// HIDE & SHOW RECIPE
// -------------------------------------------------------


var hideRecipe = function hideRecipe(callback) {
...
var showRecipe = function showRecipe(callback) {
...
function clickedRecipeButton() {
  ...
  if (!isNaN(recipeId) && !changingRecipe && (!recipeVisible() || recipeId !== displayedRecipeId)) {
    changingRecipe = true;
