...
var MainWindow = /*#__PURE__*/function () {
  function MainWindow(openEditorToEditCallback, openDeleteCallback) {
...
var Nav = /*#__PURE__*/function () {
  ...
  _createClass(Nav, [{
    ...
    value: function add(obj) {
      var displayRecipeCallback = this.displayRecipeCallback;
...
var Popups = /*#__PURE__*/function () {
  function Popups(saveRecipeCallback, deleteRecipeCallback) {
...
var PopupWindow = /*#__PURE__*/function () {
  function PopupWindow(openParentCallback, closeParentCallback) {
...
var EditorPopup = /*#__PURE__*/function (_PopupWindow) {
  ...
  function EditorPopup(openParentCallback, closeParentCallback, saveRecipeCallback) {
    var _this8;

    _classCallCheck(this, EditorPopup);

    _this8 = _super.call(this, openParentCallback, closeParentCallback);
  ...
  _createClass(EditorPopup, [{
    ...
    value: function addStep() {
      ...
      var nextId = this.stepsElement.childElementCount + 1;
...
var DeletePopup = /*#__PURE__*/function (_PopupWindow2) {
  ...
  function DeletePopup(openParentCallback, closeParentCallback, deleteRecipeCallback) {
    var _this10;

    _classCallCheck(this, DeletePopup);

    _this10 = _super2.call(this, openParentCallback, closeParentCallback);
    ...
    _this10.openParentCallback = openParentCallback;
    _this10.closeParentCallback = closeParentCallback;
...
var RecipeApp = /*#__PURE__*/function () {
  function RecipeApp(arr) {
    ...
    this.nav = new Nav(this.arr, this.mainWindow.display, this.popups.editor.openToAdd);
  }
