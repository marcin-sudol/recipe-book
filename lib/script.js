...
var RecipeApp = /*#__PURE__*/function () {
  function RecipeApp(arr) {
    ...
    this.mainWindow = new MainWindow(this.editPopup.openToEdit, this.deletePopup.open);
    this.nav = new Nav(this.arr, this.mainWindow.display, this.editPopup.openToAdd);
  }
