...
var RecipeWindow = /*#__PURE__*/function () {
  function RecipeWindow(openEditorCallback, openDeleteCallback, saveRecipeCallback, updateTabIndexCallback) {
    ...
    this.stepsList = document.getElementById("steps-list"); // Setting additional properties
    ...
    this.clickedDelete = this.clickedDelete.bind(this); // Adding events listeners
