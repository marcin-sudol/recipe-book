...
var Nav = /*#__PURE__*/function () {
  function Nav(arr, displayRecipeCallback, openEditorCallback, resetRecipesCallback, updateTabIndexCallback) {
    ...
    this.recipeWindow = document.getElementById("recipe-window"); // Binding methods
    ...
    this.hideTooltip = this.hideTooltip.bind(this); // Setting additional properties

    this._selectedItem = 0;
    this.itemsCounter = 0; // Adding events listeners
    ...
    this.navList.onkeydown = this.keyDownOnNavList; // Initializing item list with array
  ...
  _createClass(Nav, [{
    ...
    value: function enableTab() {
      if (!wideWindow()) {
        ...
        this.showListButton.tabIndex = "-1"; // Setting selected item to itself will also change item's button's tabindex to 0.
    ...
    key: "keyDownOnNavList",
    value: function keyDownOnNavList(e) {
