...
var Nav = /*#__PURE__*/function () {
  function Nav(arr, displayRecipeCallback, openEditorCallback, resetRecipesCallback, updateTabIndexCallback) {
    ...
    this.hideTooltip = this.hideTooltip.bind(this); // Setting DOM elements
    ...
    this.recipeWindow = document.getElementById("recipe-window"); // Saving callbacks
    ...
    this.updateTabIndexCallback = updateTabIndexCallback; // Adding events listeners
