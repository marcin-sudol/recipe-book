...
var Popup = /*#__PURE__*/function () {
  function Popup(popupClosedCallback) {
    _classCallCheck(this, Popup);

    this.open = this.open.bind(this);
    this.close = this.close.bind(this); // callback function executed efter closing popup

    this.popupClosedCallback = popupClosedCallback; // should be assigned in extending class
...
var EditPopup = /*#__PURE__*/function (_Popup) {
  ...
  function EditPopup(popupClosedCallback, saveRecipeCallback) {
    var _this;

    _classCallCheck(this, EditPopup);

    _this = _super.call(this, popupClosedCallback);
...
var DeletePopup = /*#__PURE__*/function (_Popup2) {
  ...
  function DeletePopup(popupClosedCallback, deleteRecipeCallback) {
    var _this3;

    _classCallCheck(this, DeletePopup);

    _this3 = _super2.call(this, popupClosedCallback);
